...
class AppTextStyle{
  static TextStyle primary14w600=TextStyle(fontSize: 14,color: AppColors.primaryColor,fontFamily: FontFamily.popins,fontWeight: FontWeight.w500);
  ...
  static TextStyle darkGrey14Bold=TextStyle(fontSize: 14,fontFamily: FontFamily.popins,fontWeight: FontWeight.w500,color: Colors.grey[700]);
  static TextStyle darkGrey13Bold=TextStyle(fontSize: 13,fontFamily: FontFamily.popins,fontWeight: FontWeight.w500,color: Colors.grey[700]);
